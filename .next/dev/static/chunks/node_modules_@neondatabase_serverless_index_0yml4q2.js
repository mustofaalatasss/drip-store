...
"[project]/node_modules/@neondatabase/serverless/index.js [client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
var T = (r, e)=>()=>(e || r((e = {
            exports: {}
        }).exports, e), e.exports), te = (r, e)=>{
    for(var t in e)Te(r, t, {
        get: e[t],
        enumerable: !0
    });
}, On = (r, e, t, n)=>{
    if (e && typeof e == "object" || typeof e == "function") for (let i of Ao(e))!_o.call(r, i) && i !== t && Te(r, i, {
        get: ()=>e[i],
        enumerable: !(n = Eo(e, i)) || n.enumerable
    });
    return r;
};
var Ae = (r, e, t)=>(t = r != null ? So(Co(r)) : {}, On(e || !r || !r.__esModule ? Te(t, "default", {
        value: r,
        enumerable: !0
    }) : t, r)), O = (r)=>On(Te({}, "__esModule", {
        value: !0
    }), r);
...
var Nn = T((ft)=>{
    ...
    ft.toByteArray = Bo;
    ft.fromByteArray = ko;
    var ue = [], re = [], To = typeof Uint8Array < "u" ? Uint8Array : Array, Qt = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz01\
23456789+/";
...
pport which is required by `buffer` v5.x. Use `buffer` v4.x if you require old browser support.");
    ...
    function pe(r) {
        if (r > ht) throw new RangeError('The value "' + r + '\
...
, Buffer, ArrayBuffer, Array, or Array-like Object. Received type " + typeof r);
        if (ce(r, ArrayBuffer) || r && ce(r.buffer, ArrayBuffer) || typeof SharedArrayBuffer < "u" && (ce(r, SharedArrayBuffer) || r && ce(r.buffer, SharedArrayBuffer))) return Ht(r, e, t);
...
for option "size"');
    ...
    function Do(r, e) {
        ...
        let t = Kn(r, e) | 0, n = pe(t), i = n.write(r, e);
...
ounds');
    ...
    a(qo, "fromObject");
    function Vt(r) {
        if (r >= ht) throw new RangeError("Attempt to allocate Buffer larger t\
han maximum size: 0x" + ht.toString(16) + " bytes");
        return r | 0;
    }
    a(Vt, "checked");
    function Qo(r) {
...
-bits");
    ...
    h.prototype.toString = a(function() {
        let e = this.length;
        return e === 0 ? "" : arguments.length === 0 ? Zn(this, 0, e) : No.apply(this, arguments);
    }, "toString");
...
compare");
    function Yn(r, e, t, n, i) {
        ...
        if (typeof e == "string" && (e = h.from(e, n)), h.isBuffer(e)) return e.length === 0 ? -1 : Hn(r, e, t, n, i);
        if (typeof e == "number") return e = e & 255, typeof Uint8Array.prototype.indexOf == "function" ? i ? Uint8Array.prototype.indexOf.call(r, e, t) : Uint8Array.prototype.lastIndexOf.call(r, e, t) : Hn(r, [
            e
        ], t, n, i);
...
ctionalIndexOf");
    ...
    h.prototype.indexOf = a(function(e, t, n) {
        return Yn(this, e, t, n, !0);
    }, "indexOf");
    h.prototype.lastIndexOf = a(function(e, t, n) {
        return Yn(this, e, t, n, !1);
    }, "lastIndexOf");
    function Wo(r, e, t, n) {
        t = Number(t) || 0;
        let i = r.length - t;
    ...
    a($o, "base64Write");
    function Go(r, e, t, n) {
        return pt(na(e, r.length - t), r, t, n);
    }
    a(Go, "ucs2Write");
...
access beyond buffer length");
    ...
    h.prototype.readFloatLE = a(function(e, t) {
        return e = e >>> 0, t || q(e, 4, this.length), Re.read(this, e, !0, 23, 4);
    }, "readFloatLE");
    h.prototype.readFloatBE = a(function(e, t) {
        return e = e >>> 0, t || q(e, 4, this.length), Re.read(this, e, !1, 23, 4);
    }, "readFloatBE");
    h.prototype.readDoubleLE = a(function(e, t) {
        return e = e >>> 0, t || q(e, 8, this.length), Re.read(this, e, !0, 52, 8);
    }, "readDoub\
leLE");
    h.prototype.readDoubleBE = a(function(e, t) {
        return e = e >>> 0, t || q(e, 8, this.length), Re.read(this, e, !1, 52, 8);
    }, "readDoubleBE");
...
writeInt32LE");
    ...
    h.prototype.writeBigInt64LE = be(a(function(e, t = 0) {
        return Jn(this, e, t, -BigInt("0x\
8000000000000000"), BigInt("0x7fffffffffffffff"));
    }, "writeBigInt64LE"));
    h.prototype.writeBigInt64BE = be(a(function(e, t = 0) {
...
riteBigInt64BE"));
    ...
    function ri(r, e, t, n, i) {
        return e = +e, t = t >>> 0, i || ei(r, e, t, 8, 17976931348623157e292, -17976931348623157e292), Re.write(r, e, t, n, 52, 8), t + 8;
    }
    a(ri, "writeDouble");
...
out of bounds");
    ...
    zt("ERR_INVALID_ARG_TYPE", function(r, e) {
...
f range.`, i = t;
        return Number.isInteger(t) && Math.abs(t) > 2 ** 32 ? i = Gn(String(t)) : typeof t == "bigint" && (i = String(t), (t > BigInt(2) ** BigInt(32) || t < -(BigInt(2) ** BigInt(32))) && (i = Gn(i)), i += "n"), n += ` It must be ${e}. Re\
ceived ${i}`, n;
    }, RangeError);
    function Gn(r) {
...
nd <= ${t}${o}`, new Pe.ERR_OUT_OF_RANGE("value", u, r);
        }
        Xo(n, i, s);
    }
    a(ni, "checkIntBI");
...
var ve = T((Fl, Yt)=>{
    ...
    Object.defineProperty(R, "defaultMaxListeners", {
        ...
        set: a(function(r) {
            if (typeof r != "number" || r < 0 || ui(r)) throw new RangeError('The valu\
e of "defaultMaxListeners" is out of range. It must be a non-negative number. Received ' + r + ".");
    ...
    R.prototype.setMaxListeners = a(function(e) {
        if (typeof e != "number" || e < 0 || ui(e)) throw new RangeError('Th\
e value of "n" is out of range. It must be a non-negative number. Received ' + e + ".");
    ...
    function li(r, e, t, n) {
        var i, s, o;
        if (yt(t), s = r._events, s === void 0 ? (s = r._events = Object.create(null), r._eventsCount = 0) : (s.newListener !== void 0 && (r.emit("newListener", e, t.listener ? t.listener : t), s = r._events), o = s[e]), o === void 0) o = s[e] = t, ++r._eventsCount;
            ...
            o,
            t
        ] : n ? o.unshift(t) : o.push(t), i = ci(r), i > 0 && o.length > i && !o.warned) {
            o.warned = !0;
...
trict";
    ...
    wi = Ae(ve(), 1);
    a(ha, "isIP");
    mi = /^[^.]+\./, S = class S extends wi.EventEmitter {
        constructor(){
            super(...arguments);
            E(this, "opts", {});
            E(this, "connecting", !1);
...
S"
    ...
    var sr = "([+-]?\\d+)", Qa = sr + "\\s+years?", Na = sr + "\\s+mons?", Wa = sr + "\\s+days?", ja = "\
...
parseBigInteger"), Di = a(function(r) {
    ...
    }, "parseJsonArray"), lr = a(function(r) {
        ...
        r(20, Ni), r(21, cr), r(23, cr), r(26, cr), r(700, parseFloat), r(701, parseFloat), r(16, Qi), r(1082, xt), r(1114, xt), r(1184, xt), r(600, lr), r(651, ne), r(718, eu), r(1e3, za), r(1001, Xa), r(1005, or), r(1007, or), r(1028, or), r(1016, Ya), r(1017, Za), r(1021, ar), r(1022, ar), r(1231, ar), r(1014, ne), r(1015, ne), r(1008, ne), r(1009, ne), r(1040, ne), r(1041, ne), r(1115, ur), r(1182, ur), r(1185, ur), r(1186, Oi), r(1187, Ja), r(17, qi), r(114, JSON.parse.bind(JSON)), r(3802, JSON.parse.bind(JSON)), r(199, Di), r(3807, Di), r(3907, ne), r(2951, ne), r(791, ne), r(1183, ne), r(1270, ne);
    }, "init");
    Wi.exports = {
        init: tu
    };
...
t implemented: " + l);
        ...
        r(20, nu), r(21, iu), r(23, Gi), r(26, Gi), r(1700, au), r(700, su), r(701, ou), r(16, cu), r(1114, Vi.bind(null, !1)), r(1184, Vi.bind(null, !0)), r(1e3, Je), r(1007, Je), r(1016, Je), r(1008, Je), r(1009, Je), r(25, uu);
    }, "init");
    Ki.exports = {
        init: lu
    };
...
function rt(r) {
    let e = 1779033703, t = 3144134277, n = 1013904242, i = 2773480762, s = 1359893119, o = 2600822924, u = 528734635, c = 1541459225, l = 0, f = 0, y = [
        ...
        for(let B = 16; B < 64; B++){
            let j = g(A[B - 15], 7) ^ g(A[B - 15], 18) ^ A[B - 15] >>> 3, fe = g(A[B - 2], 17) ^ g(A[B - 2], 19) ^ A[B - 2] >>> 10;
            A[B] = A[B - 16] + j + A[B - 7] + fe | 0;
        }
        let I = e, w = t, Z = n, W = i, J = s, X = o, oe = u, ae = c;
        for(let B = 0; B < 64; B++){
            let j = g(J, 6) ^ g(J, 11) ^ g(J, 25), fe = J & X ^ ~J & oe, me = ae + j + fe + y[B] + A[B] | 0, Ge = g(I, 2) ^ g(I, 13) ^ g(I, 22), he = I & w ^ I & Z ^ w & Z, Ie = Ge + he | 0;
...
var it = T((Wf, pr)=>{
    ...
    var Oe = tt(), xu = Oe.getTypeParser(20, "text"), Su = Oe.getTypeParser(1016, "text");
    pr.exports.__defineSetter__("parseInt8", function(r) {
        Oe.setTypeParser(20, "text", r ? Oe.getTypeParser(23, "text") : xu), Oe.setTypeParser(1016, "text", r ? Oe.getTypeParser(1007, "text") : Su);
    });
});
var st = T((Hf, is)=>{
    "use strict";
...
var ds = T((nh, ps)=>{
    ...
    function Mu(r) {
        ...
        let e = wr.randomBytes(18).toString("base64");
        return {
...
art with client nonce");
        var i = d.from(n.salt, "base64"), s = Wu(e, i, n.iteration), o = qe(s, "Client Key"), u = Nu(o), c = "n=*,r=" + r.clientNonce, l = "r=" + n.nonce + ",s=" + n.salt + ",i=" + n.iteration, f = "c=biws,r=" + n.nonce, y = c + "," + l + "," + f, g = qe(u, y), A = hs(o, g), C = A.toString("base64"), D = qe(s, "Server Key"), Y = qe(D, y);
        r.message = "SAS\
...
var vs = T((ph, bs)=>{
    "use strict";
    p();
    var { Transform: Gu } = (Er(), O(Sr)), { StringDecoder: Vu } = (ms(), O(ys)), Se = Symbol("last"), It = Symbol("decoder");
    function zu(r, e, t) {
        let n;
        if (this.overflow) {
    ...
    a(zu, "transform");
    function Ku(r) {
        if (this[Se] += this[It].end(), this[Se]) try {
    ...
    function Yu(r, e, t) {
        ...
        let n = new Gu(t);
        return n[Se] = "", n[It] = new Vu("utf8"), n.matcher = r, n.mapper = e, n.maxLength = t.maxLength, n.skipOverflow = t.skipOverflow || !1, n.overflow = !1, n._destroy = function(i, s) {
...
var Es = T((mh, ye)=>{
    ...
    var Qe = [
        ...
        "user",
        "password"
    ], _r = Qe.length, sc = Qe[_r - 1];
    function Ir() {
        var r = ut instanceof Zu && ut.writable === !0;
        if (r) {
...
`);
    ...
    a(Ir, "warn");
    Object.defineProperty(ye.exports, "isWin", {
        get: a(function() {
            return Tt;
        }, "get"),
        set: a(function(r) {
...
postgresql", "pgpass.conf") : xs.join(e.HOME || "./", ".pgpass"));
    ...
    ye.exports.usePgPass = function(r, e) {
        return Object.prototype.hasOwnProperty.call(m.env, "PGPASSWORD") ? !1 : Tt ? !0 : (e = e || "<unkn>", ic(r.mode) ? r.mode & (ec | tc) ? (Ir('WARNING: password file "%s" has group or world access; permissions should be u=rw \
(0600) or less', e), !1) : !0 : (Ir('WARNING: password file "%s" is not a plain file', e), !1));
    };
    ...
    ye.exports.getPassword = function(r, e, t) {
        ...
        var o = a(function() {
            ...
            e.destroy(), Ir("WARNING: error on reading file: %s", c), t(void 0);
        }, "onErr");
    ...
    var ac = ye.exports.parseLine = function(r) {
        ...
        for(var e = "", t = "", n = 0, i = 0, s = 0, o = {}, u = !1, c = a(function(f, y, g) {
            ...
            if (e = r.charAt(l + 1), t = r.charAt(l), u = n == _r - 1, u) {
                c(n, i);
                break;
            }
...
mber" && (this.keepalives_idle = Math.floor(e.keepAliveInitialDelayMillis / 1e3));
        ...
        getLibpqConnectionString(e) {
            ...
            if (ie(t, n, "sslmode"), ie(t, n, "sslca"), ie(t, n, "s\
slkey"), ie(t, n, "sslcert"), ie(t, n, "sslrootcert"), this.database && t.push("dbname=" + Ne(this.database)), this.replication && t.push("replication=" + Ne(this.replication)), this.host && t.push("host=" + Ne(this.host)), this.isDomainSocket) return e(null, t.join(" "));
...
sage");
    ...
    a(an, "NotificationResponseMessa\
ge");
    var Gr = an;
...
xecuting queries"));
        ...
        for(let t = 0; t < r.length; t++){
            let n = e ? e(r[t], t) : r[t];
            n == null ? (F.addInt16(0), We.addInt32(-1)) : n instanceof d ? (F.addInt16(1), We.addInt32(n.length), We.add(n)) : (F.addInt16(0), We.addInt32(d.byteLength(n)), We.addString(n));
        }
    }, "\
writeValues"), Ec = a((r = {})=>{
        ...
        let e = `${r.type}${r.name || ""}`;
        return mn(67, e);
    }, "close"), Bc = a((r)=>F.add(r).flush(100), "copyData"), Lc = a((r)=>mn(102, r), "copyFail"), Lt = a((r)=>d.from([
            r,
            0,
            0,
            0,
...
e not supported yet");
        ...
        parse(e, t) {
            ...
            for(; i + Hs <= n;){
                let s = this.buffer[i], o = this.buffer.readUInt32BE(i + bn), u = bn + o;
                if (u + i <= n) {
...
var Sn = T((Ee)=>{
    ...
    var Nc = hn();
    Object.defineProperty(Ee, "DatabaseError", {
        enumerable: !0,
        get: a(function() {
...
rMessage", this._handleErrorMessage.bind(this)), e.on("readyForQuery", this._handleReadyForQuery.bind(this)), e.on("notice", this._handleNotice.bind(this)), e.on("rowDescription", this._handleRowDescription.bind(this)), e.on("dataRow", this._handleDataRow.bind(this)), e.on("portalSuspended", this._handlePortalSuspended.bind(this)), e.on("emptyQuery", this._handleEmptyQuery.bind(this)), e.on("commandComplete", this._handleCommandComplete.bind(this)), e.on("parseComplete", this._handleParseComplete.bind(this)), e.on("copyInResponse", this._handleCopyInResponse.bind(this)), e.on("copyData", this._handleCopyData.bind(this)), e.on("notification", this._handleNotification.bind(this));
        ...
        _handleAuthSASL(e) {
            this._checkPgPass(()=>{
                this.saslSession = _n.startSession(e.mechanisms), this.connection.sendSASLInitialResponseMessage(this.saslSession.mechanism, this.saslSession.response);
            });
        }
        _handleAuthSASLContinue(e) {
            _n.continueSession(this.saslSession, this.password, e.data), this.connection.sendSCRAMClientFinalMessage(this.saslSession.response);
        }
...
var io = T((up, no)=>{
    "use strict";
    p();
    var nl = ve().EventEmitter, to = a(function() {}, "NOOP"), ro = a((r, e)=>{
        let t = r.findIndex(e);
...
l after calling end on the pool");
            ...
            this.options.connectionTimeoutMillis && (i = setTimeout(()=>{
                ...
                if (i && clearTimeout(i), t.on("error", n), o) this.log("client failed to connect", o), this._clients = this._clients.filter((u)=>u !== t), s && (o = new Error("Connection terminated due to connection timeout", {
                    ...
                    if (this.log("new client connected"), this.options.maxLifetimeSeconds !== 0) {
                        let u = setTimeout(()=>{
                            this.log("ending client due to expired lifetime"), this._expired.add(t), this._idle.findIndex((l)=>l.client === t) !== -1 && this._acquireClient(t, new je((l, f, y)=>y()), n, !1);
        ...
        _release(e, t, n) {
            ...
            }, this.options.idleTimeoutMillis), this.options.allowExitOnIdle && s.unref()), this.options.allowExitOnIdle && e.unref(), this._idle.push(new Tn(e, t, s)), this._pulseQueue();
        }
        query(e, t, n) {
...
var lo = T((pp, co)=>{
    ...
    var uo = ve().EventEmitter, ul = (at(), O(ot)), Fn = st(), He = co.exports = function(r, e, t) {
        uo.call(this), r = Fn.normalizeQueryConfig(r, e, t), this.text = r.text, this.values = r.values, this.name = r.name, this.callback = r.callback, this.state = "new", this._arrayMode = r.rowMode === "array", this._emitRowEvents = !1, this.on("newListener", (function(n) {
...
var ct = T((Sp, lt)=>{
    "use strict";
    p();
    var dl = eo(), yl = it(), ml = Cn(), wl = io(), { DatabaseError: gl } = Sn(), bl = a((r)=>{
        var e;
    ...
    typeof m.env.NODE_PG_FORCE_NATIVE < "u" ? lt.exports = new Mn(kn()) : (lt.exports = new Mn(dl), Object.defineProperty(lt.exports, "native", {
        ...
        get () {
            ...
            return Object.defineProperty(lt.exports, "native", {
                value: r
            }), r;
        }
    }));
...
Jt();
p();
var pa = Object.defineProperty, da = Object.defineProperties, ya = Object.getOwnPropertyDescriptors, vi = Object.getOwnPropertySymbols, ma = Object.prototype.hasOwnProperty, wa = Object.prototype.propertyIsEnumerable, xi = a((r, e, t)=>e in r ? pa(r, e, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value: t
    ...
    return r;
}, "__spreadValues"), ba = a((r, e)=>da(r, ya(e)), "__spreadProps"), va = 1008e3, Si = new Uint8Array(new Uint16Array([
    258
]).buffer)[0] === 2, xa = new TextDecoder, Xt = new TextEncoder, mt = Xt.encode("0123456789\
...
function Ea(r, { alphabet: e, scratchArr: t } = {}) {
    ...
    let n = r.length, i = n >>> 1, s = n >>> 2, o = t || new Uint16Array(n), u = new Uint32Array(r.buffer, r.byteOffset, s), c = new Uint32Array(o.buffer, o.byteOffset, i), l = e === "upper" ? gt : ze, f = 0, y = 0, g;
    if (Si) for(; f < s;)g = u[f++], c[y++] = l[g >>> 8 & 255] << 16 | l[g & 255], c[y++] = l[g >>> 24] << 16 | l[g >>> 16 & 255];
...
var bt = class bt {
    ...
    toParameterizedQuery(e = {
        ...
        for(let i = 0, s = t.length; i < s; i++)if (e.query += t[i], i < n.length) {
            ...
            else if (o instanceof xe) if (o.queryData instanceof bt) o.queryData.toParameterizedQuery(e);
            else {
...
p();
function Ke() {
    typeof window < "u" && typeof document < "u" && typeof console < "u" && typeof console.warn == "func\
tion" && console.warn(`          
        ************************************************************
        *                                                          *
...
a(_t, "NeonDbError");
var de = _t, ss = "transaction() expects an array of queries, or a function returning a\
...
function os(r) {
    ...
    return {
        query: e,
        params: t.map((n)=>Lu((0, cs.prepareValue)(n)))
    };
}
a(os, "prep\
areQuery");
function yr(r, { arrayMode: e, fullResults: t, fetchOptions: n, isolationLevel: i, readOnly: s, deferrable: o, authToken: u, disableWarningInBrowsers: c } = {}) {
...
th value placeholders ($1, $2, etc.), use sql.query("SELECT $1", [value], options).');
        return new xe(Y, new Me(P, I));
    }
    a(D, "templateFn"), D.query = (P, I, w)=>new xe(Y, {
            query: P,
            params: I ?? []
        }, w), D.unsafe = (P)=>new Ue(P), D.transaction = async (P, I)=>{
    ...
    async function Y(P, I, w) {
        let { fetchEndpoint: Z, fetchFunction: W } = se, J = Array.isArray(P) ? {
            queries: P.map((ee)=>os(ee))
        } : os(P), X = n ?? {}, oe = e ?? !1, ae = t ?? !1, B = i, j = s, fe = o;
        w !== void 0 && (w.fetchOptions !== void 0 && (X = {
            ...X,
            ...w.fetchOptions
        }), w.arrayMode !== void 0 && (oe = w.arrayMode), w.fullResults !== void 0 && (ae = w.fullResults), w.isolationLevel !== void 0 && (B = w.isolationLevel), w.readOnly !== void 0 && (j = w.readOnly), w.deferrable !== void 0 && (fe = w.deferrable)), I !== void 0 && !Array.isArray(I) && I.fetchOptions !== void 0 && (X = {
            ...X,
            ...I.fetchOptions
        });
        let me = u;
        !Array.isArray(I) && I?.authToken !== void 0 && (me = I.authToken);
        let Ge = typeof Z == "function" ? Z(g, A, {
            jwtAuth: me !== void 0
        }) : Z, he = {
...
e",
        ...
        try {
            ...
            let M = new de(`Error connecting to database: ${ee}`);
        ...
        if (we.ok) {
            ...
            if (Array.isArray(P)) {
                let M = ee.results;
                if (!Array.isArray(M)) throw new de("Neon internal error: unexpected resu\
lt format");
                return M.map(($, ge)=>{
            ...
            if (ee === 400) {
                ...
                let M = await we.text();
                throw new de(`Server error (HTTP status ${ee}): ${M}`);
            }
        }
    }
...
var xe = mr;
function as(r, { arrayMode: e, fullResults: t, types: n }) {
    let i = new us.default(n), s = r.fields.map((c)=>c.name), o = r.fields.map((c)=>i.getTypeParser(c.dataTypeID)), u = e === !0 ? r.rows.map((c)=>c.map((l, f)=>l === null ? null : o[f](l))) : r.rows.map((c)=>Object.fromEntries(c.map((l, f)=>[
                s[f],
                l === null ? null : o[f](l)
            ])));
...
ntable");
 ...
 short");
        ...
        let w = P, Z = await n.importKey("raw", w, {
            ...
            "sign"
        ]), W = new Uint8Array(await n.sign("HMAC", Z, A.encode("Client Key"))), J = await n.digest("SHA-256", W), X = "n=*,r=" + i.clientNonce, oe = "r=" + c + ",s=" + l + ",i=" + y, ae = "c=biws,r=" + c, B = X + "," + oe + "," + ae, j = await n.importKey("raw", J, {
            name: "HMAC",
            hash: {
                name: "SHA-256"
            }
        ...
        var fe = new Uint8Array(await n.sign("HMAC", j, A.encode(B))), me = d.from(W.map((M, $)=>W[$] ^ fe[$])), Ge = me.toString("base64");
        let he = await n.importKey("raw", w, {
            name: "HMAC",
            hash: {
                name: "SHA-256"
            }
            ...
            "sign"
        ]), Ie = await n.sign("HMAC", he, A.encode("Server \
Key")), we = await n.importKey("raw", Ie, {
            name: "HMAC",
            hash: {
                name: "SHA-256"
            }
        ...
        var ee = d.from(await n.sign("HMAC", we, A.encode(B)));
...
var Ot = Dn;
ke();
var le = Ae(ct()), xl = "js"; /*! Bundled license information:
...
//# sourceMappingURL=node_modules_%40neondatabase_serverless_index_0yml4q2.js.map